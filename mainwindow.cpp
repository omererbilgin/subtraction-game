...
void setTable1();
QString return_score_source(int);
...
{
    ui->setupUi(this);
    move(this->geometry().center() - frameGeometry().center());
...
void MainWindow::on_row1_clicked()
{
    ...
    if(level == 5 && !redpt){
        ...
        if(whitept){
            ...
            ui->cell1_6->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_12->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_18->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_24->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_30->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_36->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_42->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_48->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_54->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_60->setStyleSheet("border-image: url(:/blueberry.png)");
...
if(colorrow1 == true){
    ...
    ui->cell1_6->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_12->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_18->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_24->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_30->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_36->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_42->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_48->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_54->setStyleSheet("border-image: url(:/red.png)");
    ui->cell1_60->setStyleSheet("border-image: url(:/red.png)");
...
void MainWindow::on_pushButton_27_clicked()
{
    ...
    if(level == 5 && !redpt){
        ...
        if(whitept){
            ...
            ui->cell1_5->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_8->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_14->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_20->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_26->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_32->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_38->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_44->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_50->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_56->setStyleSheet("border-image: url(:/blueberry.png)");
    ...
    if(colorrow2 == true){
        ...
        ui->cell1_5->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_8->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_14->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_20->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_26->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_32->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_38->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_44->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_50->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_56->setStyleSheet("border-image: url(:/red.png)");
...
void MainWindow::on_pushButton_23_clicked()
{
    ...
    if(level == 5 && !redpt){
        ...
        if(whitept){
            ...
            ui->cell1_4->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_7->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_13->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_19->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_25->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_31->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_37->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_43->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_49->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_55->setStyleSheet("border-image: url(:/blueberry.png)");
    ...
    if(colorrow3 == true){
        ...
        ui->cell1_4->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_7->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_13->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_19->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_25->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_31->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_37->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_43->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_49->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_55->setStyleSheet("border-image: url(:/red.png)");
...
void MainWindow::on_pushButton_24_clicked()
{
    ...
    if(level == 5 && !redpt){
        ...
        if(whitept){
            ...
            ui->cell1_3->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_11->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_17->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_23->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_29->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_35->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_41->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_47->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_53->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_59->setStyleSheet("border-image: url(:/blueberry.png)");
    ...
    if(colorrow4 == true){
        ...
        ui->cell1_3->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_11->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_17->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_23->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_29->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_35->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_41->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_47->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_53->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_59->setStyleSheet("border-image: url(:/red.png)");
...
void MainWindow::on_pushButton_25_clicked()
{
    ...
    if(level == 5 && !redpt){
        ...
        if(whitept){
            ...
            ui->cell1_2->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_10->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_16->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_22->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_28->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_34->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_40->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_46->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_52->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_58->setStyleSheet("border-image: url(:/blueberry.png)");
    ...
    if(colorrow5 == true){
        ...
        ui->cell1_2->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_10->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_16->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_22->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_28->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_34->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_40->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_46->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_52->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_58->setStyleSheet("border-image: url(:/red.png)");
...
void MainWindow::on_pushButton_26_clicked()
{
    ...
    if(level == 5 && !redpt){
        ...
        if(whitept){
            ...
            ui->cell1->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_9->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_15->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_21->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_27->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_33->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_39->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_45->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_51->setStyleSheet("border-image: url(:/blueberry.png)");
            ui->cell1_57->setStyleSheet("border-image: url(:/blueberry.png)");
    ...
    if(colorrow6 == true){
        ...
        ui->cell1->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_9->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_15->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_21->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_27->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_33->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_39->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_45->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_51->setStyleSheet("border-image: url(:/red.png)");
        ui->cell1_57->setStyleSheet("border-image: url(:/red.png)");
...
void MainWindow::update_score(int sw){

switch(sw){

case 0: { // reset
    ui->score->setText(return_score_source(0));
    break;
}
case 1: { //
    ui->score->setText(return_score_source(score));
    break;
}
default: {
    // should be never reached
    qDebug("Undefined case value on fu: update_score()");
}
}
...
QString return_score_source(int num){

    QString text = "<html><head/><body><p><span style=' font-size:72pt; font-weight:600;'>" + QString::number(num) + "</span></p></body></html>";
    return text;
}
